...
`rollupTree` is a general framework for solving problems in which some property of a parent element is a combination of corresponding properties of its child elements. The mass of an assembly, for example, is the sum of the masses of its subassemblies, the mass of each subassembly is the sum of masses of its parts, etc.
